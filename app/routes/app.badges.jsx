...
const styles = {
  ...
  studioShell: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 340px), 1fr))", gap: 0, alignItems: "stretch", background: "#f6f8fb", minHeight: 660 },
  stickyPreview: { display: "grid", gridTemplateRows: "auto auto", gap: 16, alignContent: "start", padding: 20, boxSizing: "border-box", minWidth: 0, background: "linear-gradient(145deg, #111827 0%, #1f2937 44%, #0f766e 100%)", color: "#ffffff", minHeight: 660 },
  editorRail: { display: "grid", gridTemplateRows: "auto minmax(0, 1fr) auto", gap: 0, minWidth: 0, minHeight: 660, maxHeight: 660, background: "#ffffff" },
  ...
  productPreview: { alignSelf: "start", border: "1px solid rgba(255, 255, 255, 0.22)", borderRadius: 8, padding: 12, background: "rgba(255, 255, 255, 0.96)", boxShadow: "0 24px 52px rgba(0, 0, 0, 0.26)", color: "#202223" },
  ...
  productImagePreview: { position: "relative", minHeight: 300, borderRadius: 8, background: "linear-gradient(135deg, #f8fafc 0%, #e0f2fe 48%, #ccfbf1 100%)", display: "grid", placeItems: "center", padding: 20, overflow: "hidden" },
